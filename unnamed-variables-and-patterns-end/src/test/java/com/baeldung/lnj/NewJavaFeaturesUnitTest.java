...
import com.baeldung.lnj.domain.MyResource;
import com.baeldung.lnj.domain.TaskRecord;
...
class NewJavaFeaturesUnitTest {
    ...
    @Test
    void whenIteratingEntries_thenKeyIsIgnoredAndValueIsProcessed() {
        ...
        assertEquals("MY TASK", taskMap.get("t1")
            .getName());
    }
